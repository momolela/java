...
public class ThreadPoolExecutor01Base {
    ...
    public static void base() throws InterruptedException {
        ...
        threadPool = new ThreadPoolExecutor06CustomThreadPoolExecutor(50,
                190,
                5,
                TimeUnit.SECONDS,

                new ArrayBlockingQueue<>(50), // 数组有界队列，先进先出
        ...
        CountDownLatch countDownLatch = new CountDownLatch(221);
        for (int i = 0; i < 221; i++) {
